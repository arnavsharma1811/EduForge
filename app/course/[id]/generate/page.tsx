...
import { Loader2, CheckCircle2, FileText, Brain, Layout, Sparkles } from "lucide-react"
    ...
    const interval = setInterval(() => {
      setCurrentStep((prev) => {
        if (prev >= steps.length - 1) {
          ...
          setTimeout(() => {
            router.push(`/course/${params.id || 'new'}`)
          }, 1500)
          return prev + 1
        }
        return prev + 1
  ...
  return (
    <div className="flex-1 p-6 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Crafting Your Course</h1>
        <p className="text-muted-foreground max-w-md mx-auto">
          Our AI is analyzing your document and building a comprehensive learning experience.
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {isActive && <p className="text-xs text-primary animate-pulse mt-1">Processing...</p>}
                </div>
              </div>
            )
          })}
